...
def q_learning(env: SingleAgentEnv, alpha: float, epsilon: float, gamma: float, max_iter: int, name_env="") -> PolicyAndActionValueFunction:
    assert(epsilon > 0)
    ...
    graph_score("Q learning on " + name_env, score, 500)
    graph_score_bar("Q learning on "
                    + name_env
